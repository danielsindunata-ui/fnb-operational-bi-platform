...
planning_date + branch_code + product_code

## Main Consumers

| Consumer | Usage |
|---|---|
| Power BI table/page | What it uses this mart for |

## Main Sources

| Source Object | Purpose |
|---|---|
| schema.object_name | Why it is needed |

## Business Logic

Describe calculation logic in business language. Avoid only writing SQL. Explain what the calculation means operationally.
